...
<p align="center">
  <img src="assets/screenshots/screenshot-stats-fraud.png" alt="Detección de Anomalías y Fraude" width="48%" style="border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);" />
  <img src="assets/screenshots/screenshot-stats-abtesting.png" alt="Calculadora de Inferencia y A/B Testing" width="48%" style="border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);" />
</p>
